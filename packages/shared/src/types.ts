...
export interface CandleFeatures { h4Bias: 'BULLISH' | 'BEARISH' | 'NEUTRAL'; h1Structure: boolean; bos: boolean; supplyDemand: boolean; liquidity: boolean; momentum: boolean; rr: number; }
